...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> Update(UserForRegisterDto userForRegisterDto, string email)
        {
            ...
            return new SuccessDataResult<User>(user, UserMessages.Updated);
        }
        ...
        public IResult Delete(string email)
        {
            ...
            if (result == null)
            {
                return new ErrorResult(UserMessages.RecordNotFound);
            }
